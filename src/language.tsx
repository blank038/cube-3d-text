...
export const languageConfig: Readonly<LanguageConfig> = {
    ...
    ja_JP: {
        ...
        gradient: "グラデーション",
        image: "画像",
        selectColor: "{side} の色を選択",
        selectColorStart: "{side} の開始色を選択",
        selectColorEnd: "{side} の終了色を選択",
        repeat: "繰り返し",
        offset: "オフセット",
        Upload: "アップロード",
        repeatX: "X軸の繰り返し (スケール)",
        repeatY: "Y軸の繰り返し (スケール)",
        offsetX: "X軸オフセット",
        offsetY: "Y軸オフセット",
        presuppose: "プリセット",
        customize: "カスタム",
